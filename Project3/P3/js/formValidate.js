/********w************
	...
	Name: Navjot Kaur
	Date: April 12, 2023
	Description: In this file Validation of file is done.
...
function formHasErrors() {
	...
	function formHasErrors() {
		...
		if(numberOfItemsInCart() == 0) {
			...
			cartError.classList.add("visible");
			hasErrors = true;
		}
		...
		if(name.value.trim() == "") {
			...
			errorForName.classList.add("visible");
			if (!hasErrors) {
				name.focus();
			}
			hasErrors = true;
		...
		if(address.value.trim() == "") {
			let errorForAddress = document.getElementById('errorForAddress');
			errorForAddress.classList.add("visible");
			if (!hasErrors) {
				address.focus();
			}
			hasErrors = true;
		...
		if(city.value.trim() == "") {
			let errorForCity = document.getElementById('errorForCity');
			errorForCity.classList.add("visible");
			if (!hasErrors) {
				city.focus();
			}
			hasErrors = true;
		...
		if(province.value.trim() == "") {
			let errorForProvince = document.getElementById('errorForProvince');
			errorForProvince.classList.add("visible");
			if (!hasErrors) {
				province.focus();
			}
			hasErrors = true;
		...
		if(postalCode.value.trim() == "") {
			let errorForPostalCode = document.getElementById('errorForPostalCode');
			errorForPostalCode.classList.add("visible");
			if (!hasErrors) {
				postalCode.focus();
			}
			hasErrors = true;
		...
		if(nameOnCard.value.trim() == "") {
			let errorForNameOnCard = document.getElementById('errorForNameOnCard');
			errorForNameOnCard.classList.add("visible");
			if (!hasErrors) {
				nameOnCard.focus();
			}
			hasErrors = true;
		...
		let numberOfCard = document.getElementById('numberOfCard');
		if(numberOfCard.value.trim() == "") {
			let errorForCardNumbers = document.getElementById('errorForCardNumbers');
			errorForCardNumbers.classList.add("visible");
			if (!hasErrors) {
				numberOfCard.focus();
			}
			hasErrors = true;
		...
		if(expiryMonth.value.trim() == "") {
			let errorForExpiryMonth = document.getElementById('errorForExpiryMonth');
			errorForExpiryMonth.classList.add("visible");
			if (!hasErrors) {
				expiryMonth.focus();
			}
			hasErrors = true;
		...
		if(expiryYear.value.trim() == "") {
			let errorForExpiryYear = document.getElementById('errorForExpiryYear');
			errorForExpiryYear.classList.add("visible");
			if (!hasErrors) {
				expiryYear.focus();
			}
			hasErrors = true;
